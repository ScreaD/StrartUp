...
<html lang="en">
	<head>
		...
		<meta charset="utf-8">
		<title>StartUP <c:out value="${project.name}"/></title>
            ...
            <div class="col-md-10 col-sm-9">
              ...
              <div class="row">
                <div class="col-xs-9">
                  ...
                  <p>Collected already <c:out value="${project.moneyHas}"/> of <c:out value="${project.moneyNeed}"/></p>
				  <p>History: <c:out value="${project.history}"/></p>
				  <p>Days left: <c:out value="${project.daysLeft}"/></p>
				  <p>Question: <c:out value="${project.question}"/></p>
